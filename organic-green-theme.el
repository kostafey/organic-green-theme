...
(let* ((class '((class color) (min-colors 89)))
  ...
  (custom-theme-set-faces
   ...
   `(rainbow-delimiters-depth-2-face ((t (:foreground "#5544EE"))))
   `(rainbow-delimiters-depth-3-face ((t (:foreground "#2265DC"))))
   `(rainbow-delimiters-depth-4-face ((t (:foreground "#00A89B"))))
   `(rainbow-delimiters-depth-5-face ((t (:foreground "#229900"))))
   `(rainbow-delimiters-depth-6-face ((t (:foreground "#999900"))))
   `(rainbow-delimiters-depth-7-face ((t (:foreground "#F57900"))))
   `(rainbow-delimiters-depth-8-face ((t (:foreground "#EE66E8"))))
